...
# a modified model-cat-dog-panda of AlexNet, include 5 convlotional layers and 3 full-connect layers
...
def train(epochs, trainLoader, model, device, Lr, momen):
    ...
    torch.save(model, 'myAlexMnistDemo.pth')  # save net model-cat-dog-panda and parameters
...
def main():
    ...
    parser.add_argument("--stage", type=str, default='predict', help="is train or test")
    ...
    parser.add_argument("--predictImg", type=str, default='predictImg/img_2.png', help="image need to be predicted")
